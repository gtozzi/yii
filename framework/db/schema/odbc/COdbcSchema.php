...
/**
 * COdbcSchema is the class for retrieving metadata information from a MS SQL Server database.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @author Christophe Boulain <Christophe.Boulain@gmail.com>
 * @author Gabriele Tozzi <gabriele@tozzi.eu>
...
class COdbcSchema extends CDbSchema
{
	 ...
	 * @param string $name table name
	 * @return COdbcTableSchema driver dependent table metadata. Null if the table does not exist.
	 */
	protected function loadTable($name)
	{
		$table=new COdbcTableSchema;
	 ...
	 * @param COdbcTableSchema $table the table instance
	 ...
	 * @param COdbcTableSchema $table table
	...
	protected function findPrimaryKey($table)
	{
		...
		SELECT k.column_name field_name
		   ...
		   WHERE c.constraint_type LIKE 'PRIMARY KEY'
...
EOD;
	 ...
	 * @param COdbcTableSchema $table the table metadata
...
EOD;
	 ...
	 * This method overrides parent implementation in order to create a ODBC specific command builder
	 * @return CDbCommandBuilder command builder instance
	 */
	protected function createCommandBuilder()
	{
		return new COdbcCommandBuilder($this);
	}
